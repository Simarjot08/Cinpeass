...
// import { assets, dummyDateTimeData,dummyShowsData } from '../../../../../../public/data/assets';
...
//               className={`h-8 w-8 rounded border border-red-800/60 cursor-pointer ${selectedSeats.includes(seatId)&&"bg-primary text-white"}`}>
//               {seatId}
//               </button>
//             )
//           })}
...
//   </p>
// </div>
//     <div className='flex flex-col bg-backdetail md:flex-row px-6 md:px-10 lg:px-40 py-30 md:pt-50'>
        
        
//         <div className='w-60 bg-red-800/70 border border-primary/20 rounded-lg py-10 h-max md:sticky md:top-30'>
//         <p className='text-lg font-semibold px-6'>Available Timings</p>
//         <div className='mt-5 space-y-1'>
//        {show.dateTime[date].map((items)=>(
//         <div  key={items.time} onClick={()=>setSelectedTime(items)} className={`flex items-center gap-2 px-6 py-2 w-max rounded-r-md cursor-pointer transition ${selectedTime?.time === items.time? "bg-primary text-white":"hover:bg-primary/20"}`}>
...
//       <img src="/images/screenImage_red.svg" alt="screen" className='text-red-500'></img>
...
//       <button onClick={handleclick} className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-red-800 hover:bg-red-700/70 hover:scale-[1.05] transition rounded-full font-medium cursor-pointer actice:scale-95'>
//         Proceed to Checkout !
...
//             className='flex items-center gap-1 mt-20 px-10 py-3 text-sm bg-red-800 hover:bg-red-700/70 hover:scale-[1.05] transition rounded-full font-medium cursor-pointer actice:scale-95'
//           >
//             Proceed to Checkout !
//             <ArrowRightIcon strokeWidth={3} className="w-4 h-4" />
//           </button>
...
function SeatLayout() {
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      // Redirect to Stripe Checkout if URL present
      // if (data.success && data.url) {
